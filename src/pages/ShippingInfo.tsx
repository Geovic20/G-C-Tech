  ...
  const methods = [
    {
      ...
      price: 'Free',
      description: 'Reliable and affordable shipping for non-urgent orders.',
      icon: Truck
    },
    {
      ...
      price: '5,000 F',
      description: 'Get your tech faster with our priority shipping service.',
      icon: Clock
    },
    {
      ...
      price: '10,000 F',
      description: 'Available in major cities for orders placed before 12 PM.',
      icon: Package
    }
  ];
        ...
        <div className="px-4 md:px-12 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-black mb-8 relative z-10">International Shipping</h2>
              <div className="space-y-6 relative z-10">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">We ship to over 100 countries worldwide with our global logistics partners.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="font-bold mb-1">Customs & Duties</h4>
                    <p className="text-blue-100 text-sm">We handle all customs documentation to ensure a smooth delivery process.</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="space-y-8"
            >
              <h2 className="text-2xl md:text-3xl font-black text-gray-900">Track your package</h2>
