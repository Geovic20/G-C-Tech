...
const HELP_CATEGORIES = {
  en: [
    { category: 'Orders', icon: ShoppingBag, questions: ['How do I track my order?', 'Can I change my delivery address?', 'How do I cancel my order?'] },
    { category: 'Shipping', icon: Truck, questions: ['What are your shipping rates?', 'Do you offer international shipping?', 'How long will delivery take?'] },
    { category: 'Returns', icon: RotateCcw, questions: ['What is your return policy?', 'How do I start a return?', 'When will I get my refund?'] },
    { category: 'Payments', icon: ShieldCheck, questions: ['What payment methods do you accept?', 'Is my payment information secure?', 'Do you offer financing options?'] }
  ],
  fr: [
    { category: 'Commandes', icon: ShoppingBag, questions: ['Comment suivre ma commande ?', 'Puis-je modifier mon adresse de livraison ?', 'Comment annuler ma commande ?'] },
    { category: 'Livraison', icon: Truck, questions: ['Quels sont vos tarifs de livraison ?', 'Proposez-vous la livraison internationale ?', 'Combien de temps prend la livraison ?'] },
    { category: 'Retours', icon: RotateCcw, questions: ['Quelle est votre politique de retour ?', 'Comment initier un retour ?', 'Quand serai-je remboursé ?'] },
    { category: 'Paiements', icon: ShieldCheck, questions: ['Quels moyens de paiement acceptez-vous ?', 'Mes informations de paiement sont-elles sécurisées ?', 'Proposez-vous des facilités de paiement ?'] }
  ]
};
...
export default function HelpCenter() {
  ...
  const categories = HELP_CATEGORIES[language];
